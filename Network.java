...
public class Network extends Thread {
    ...
    private static Semaphore semEmpty;
    private static Semaphore semFull = new Semaphore(0);

    private static Semaphore semMutexOut = new Semaphore(1);
    private static Semaphore semEmptyOut;
    private static Semaphore semFullOut = new Semaphore(0);
    /** 
     ...
     */
     Network( )
      { 
         ...
         semEmptyOut = new Semaphore(maxNbPackets);
